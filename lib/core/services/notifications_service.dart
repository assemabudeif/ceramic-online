...
class NotificationsService {
  ...
  /// This method is used to update the FCM token of the device
  ...
  static _createNewNotification({
    ...
    const AndroidNotificationDetails androidNotificationDetails =
      ...
      'ceramic_online_id',
      'Ceramic Online Channel',
      channelDescription: 'Ceramic Online Channel Description',
